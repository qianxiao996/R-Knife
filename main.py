...
<<<<<<< HEAD
        ...
        try:
            pass
            # filename = config_setup.get('Setting','qss')
            # print(filename)

            # with open('conf/qss/' + filename, 'r', encoding='utf-8') as f:
            #     qss_style = f.read()
            #     f.close()
...
<<<<<<< HEAD
        ...
        Dialog.setAttribute(QtCore.Qt.WidgetAttribute.WA_TranslucentBackground)  # 窗口透明
