...
class Class_Encode:
    ...
    def func_HTMLEncode(self, encode_type, source_text):
    ...
    def func_Base16(self, encode_type, source_text):
        text = base64.b16encode(source_text.encode(encode_type))
        result_text = str(text, encoding=encode_type)
    ...
    def func_百家姓(sellf, encode_type, source_text):
        CODE = {
